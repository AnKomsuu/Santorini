...
import fon from "../assets/images/roomsFon.jpg";
import HeroBookingForm from "../components/booking/HeroBookingForm";
import decore from "../assets/icons/roomsDecore.svg";
import RoomCard from "../components/RoomCard/RoomCard";
import decore2 from "../assets/icons/decoreMini2.svg";
  ...
  return (
    <div className="container py-10">
      ...
      <div className="relative flex justify-center items-center flex-col my-10 md:my-12 h-auto md:h-55">
        <img className="absolute w-1/2 md:w-auto -z-10" src={decore} alt="" />
