...
import pubPool from "../assets/images/pubPool.jpg";
import pool from "../assets/images/pool.jpg";
import playground from "../assets/images/playground.jpg";
import fon from "../assets/images/wellness.jpg";
      ...
      <section id="gastronomy" className="py-20 bg-theme-50">
        <div className="container">
          ...
          <div className="grid grid-cols-3 gap-x-12 items-center">
            ...
            <div>
              <h3 className="text-2xl md:text-3xl lg:text-4xl mb-10">
                Ресторан 'Grace'
              </h3>
              <p className="text-xl">
