...
import santorini from "../../../assets/icons/santorini.svg";
              ...
              <img
                ...
                className={`h-8 md:h-10 w-auto object-contain transition-all duration-300 ${
                  isScrolled
                    ...
                    : "brightness-0 invert drop-shadow-md md:filter-none"
                }`}
              />
            </Link>
          </div>
              ...
              <Link
                ...
                className={`text-sm font-bold uppercase tracking-wider hover:text-blue-500 transition-colors relative group ${
                  isScrolled
                    ...
                    : "text-slate-800 dark:text-white text-shadow-sm"
                }`}
              >
                {link.title}
      ...
      >
        <div className="flex flex-col h-full p-6">
          ...
          <div className="mt-auto pt-8 border-t border-gray-100 dark:border-gray-800">
            <a
              href="tel:89120388044"
              className="flex items-center gap-x-3 text-lg font-medium text-slate-800 dark:text-white mb-4"
            >
              <FiPhone className="text-blue-600" />8 (912) 038-80-44
            </a>
            {!isAuth && (
              <Link
                to="/login"
